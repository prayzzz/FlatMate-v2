...
namespace FlatMate.Module.Account.DataAccess.Repositories
{
    ...
    public class AuthenticationRepository : IAuthenticationRepository
    {
        ...
        public AuthenticationRepository()
        {
            ...
            _auth.Add(UserDto.Fake.Id.Value, new AuthenticationInformationDto { PasswordHash = "yW85+CZVyIHSMlqgBx71N4h7Ku+qE32f3cWZbBmGSrUS9eXCmMvKIbchXd7G9SxsPus48ximHcKm6YG/UmAh7Q==", Salt = "CwvDrFV38guhMmq0P0rp+w==", UserId = UserDto.Fake.Id.Value });
        }
